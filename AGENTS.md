...
- **Code style:** Use 4 spaces for indentation (not tabs). String quote style is flexible but should be consistent within each file. Indentation is enforced via automated tests in `test/code-style.test.js`.
## Git
